                ...
                <div class="col-9">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a class="text-muted text-decoration-none" href="{{ route('customers.index') }}">Halaman Kategori Blog</a></li>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <form method="POST" action="{{ route('blog_categories.update', $data_blog_categories->id) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row">
                                    <div class="form-group mb-3">
                                        ...
                                        <input
                                            ...
                                            class="form-control"
                                            id="name"
                                            value="{{ $data_blog_categories->name }}"
                                            required>
                                        <input
                                            type="hidden"
                                            name="slug"
                                            class="form-control"
                                            id="slug"
                                            value="{{ $data_blog_categories->slug }}"
                                            readonly>
                                    </div>
                                    ...
                                    <script>
                                        ...
                                        // Jika data sudah ada, hasilkan slug dari nilai awal name
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea cols="80" id="description" class="form-control" name="description" rows="2" data-sample="1" data-sample-short>{{ $data_blog_categories->description }}</textarea>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" name="position" class="form-control" id="position" value="{{ $data_blog_categories->position }}">
                                    </div>
                                    <div class="form-group mb-3">
