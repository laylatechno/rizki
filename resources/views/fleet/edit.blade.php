                ...
                <div class="col-9">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a class="text-muted text-decoration-none" href="{{ route('customers.index') }}">Halaman Fleet</a></li>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <form method="POST" action="{{ route('fleets.update', $data_fleets->id) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="name" class="form-control" id="name" value="{{ $data_fleets->name }}" required>
                                </div>
                                <div class="form-group mb-3">
                                    <label for="category">Kategori</label>
                                    <input type="text" name="category" class="form-control" id="category" value="{{ $data_fleets->category }}">
                                </div>
                                <div class="form-group mb-3">
                                    <label for="price">Harga <span class="text-danger">*</span></label>
                                    <input type="text" name="price" class="form-control" id="price" value="{{ $data_fleets->price }}" placeholder="Masukkan Harga Sewa" oninput="formatPrice(this)" required>
                                </div>
                                <script>
                                    // Format Harga
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea cols="80" id="description" name="description" rows="10" data-sample="1" data-sample-short>{{ $data_fleets->description }}</textarea>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" name="position" class="form-control" id="position" value="{{ $data_fleets->position }}">
                                </div>
                                <div class="form-group mb-3">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 mt-3">
                                    ...
                                    <a class="btn btn-warning btn-sm mb-3" href="{{ route('fleets.index') }}"><i class="fa fa-undo"></i> Kembali</a>
                                </div>
                            </div>
