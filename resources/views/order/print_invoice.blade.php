...
<body>
    <div class="header">
        ...
        <p>Tanggal Penjualan: {{ \Carbon\Carbon::parse($order->order_date)->locale('id')->isoFormat('dddd, D MMMM YYYY') }}</p>
        <p>Pelanggan: {{ $order->pelanggan->name ?? 'No Data' }}</p>
        <p>Pengguna: {{ $order->user->name }}</p>
    ...
    <div class="additional-info">
        <div class="payment-details">
            ...
            <p>
                ...
                <span class="status-badge status-pesanan-pembelian">Pesanan Penjualan</span>
                @else
    ...
    <div class="total-cost">
        <p>Total Penjualan: Rp {{ number_format($order->total_cost, 0, ',', '.') }}</p>
    </div>
