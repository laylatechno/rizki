...
<body>
  ...
  <div class="bgimg w3-display-container w3-animate-opacity w3-text-white">
    ...
    <div class="w3-display-middle">
      ...
      <h1 class="w3-jumbo w3-animate-top" style="text-align: center;">505 - HTTP Version Not Supported</h1>

      <hr class="w3-border-grey" style="margin:auto;width:40%">
      <p class="w3-large w3-center">Versi HTTP yang digunakan tidak didukung oleh server kami.</p>
      <p class="w3-large w3-center">Silakan coba gunakan browser atau perangkat yang lebih baru.</p>
      <p class="w3-large w3-center"> <a href="{{ url('/home') }}">Kembali ke Beranda</a></p>
