                ...
                <div class="col-9">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a class="text-muted text-decoration-none" href="{{ route('customers.index') }}">Halaman Travel Route</a></li>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <form method="POST" action="{{ route('travel_routes.update', $data_travel_routes->id) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row">
                                    <div class="form-group mb-3">
                                        <label for="name">Nama Travel Route</label>
                                        <input type="text" name="name" class="form-control" id="name" value="{{ $data_travel_routes->name }}" required>
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="start">Rute Awal</label>
                                        <input type="text" name="start" class="form-control" id="start" value="{{ $data_travel_routes->start }}">
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="end">Rute Akhir</label>
                                        <input type="text" name="end" class="form-control" id="end" value="{{ $data_travel_routes->end }}">
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="price">Harga <span class="text-danger">*</span></label>
                                        <input type="text" name="price" class="form-control" id="price" value="{{ $data_travel_routes->price }}" placeholder="Masukkan Harga" oninput="formatPrice(this)" required>
                                    </div>
                                    <script>
                                        // Format Harga
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea class="form-control" name="description" id="description">{{ $data_travel_routes->description }}</textarea>
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="position">Urutan</label>
                                        <input type="number" name="position" class="form-control" id="position" value="{{ $data_travel_routes->position }}">
                                    </div>
                                    <div class="form-group mb-3">
